...
import CyclistProfile from "./cylist/CyclistProfile";
import CyclistBicycle from "../features/cyclist/components/CyclistBicycle";
...
My Profile
                ...
                <p className="text-sm text-slate-500">
                    Manage your personal information, bike, and account settings.
                </p>
            </div>
